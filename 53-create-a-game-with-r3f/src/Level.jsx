...
const wallMaterial = new THREE.MeshStandardMaterial({ color: '#387777', metalness : 0, roughness: 0 })
...
export function BlockEnd({ position = [0, 0, 0] }) {
    ...
    return <group position={position}>
        ...
        <RigidBody type="fixed" colliders="hull" restitution={0.2} friction={0}>
            <primitive object={hamburger.scene} scale={0.2} position={[0, 0.25, 0]} />
        </RigidBody>
    </group>
}
...
export function Level({ count = 8, types = [BlockSpinner, BlockAxe, BlockLimbo], seed = 0 }) {
